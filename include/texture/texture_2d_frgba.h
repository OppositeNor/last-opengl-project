#ifndef __TEXTURE_2D_FRGBA_H__
#define __TEXTURE_2D_FRGBA_H__
#include "texture/texture_2d.h"
#include <memory>

class Texture2DFRGBA : public Texture2D {
public:
    Texture2DFRGBA(const TextureConfigurations& p_config)
        : texture_id(0), config(p_config), data(nullptr, free_data) {

    }
    virtual ~Texture2DFRGBA() override;
    Texture2DFRGBA(const Texture2DFRGBA&) = delete;
