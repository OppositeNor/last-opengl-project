#ifndef __APPLICATION_SPONZA_LPV_H__
#define __APPLICATION_SPONZA_LPV_H__
...
class ApplicationSpnzaLPV : public Application, public KeyboardInputEventObserver, public WindowResizeEventObserver {
public:

    ApplicationSpnzaLPV() = default;

    ApplicationSpnzaLPV(const ApplicationSpnzaLPV&) = delete;
    ApplicationSpnzaLPV(ApplicationSpnzaLPV&&) = delete;
    ApplicationSpnzaLPV& operator=(const ApplicationSpnzaLPV&) = delete;
    ApplicationSpnzaLPV& operator=(ApplicationSpnzaLPV&&) = delete;
