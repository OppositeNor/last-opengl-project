...
void ApplicationSponza::init(const char* p_window_title, int p_window_width, int p_window_height) {
...
void ApplicationSponza::init_framebuffers(int p_window_width, int p_window_height) {
...
void ApplicationSponza::init_scene() {
...
bool ApplicationSponza::window_should_close() {
    return application_window == nullptr || application_window->should_close();
}

void ApplicationSponza::process(double p_delta_time) {
...
void ApplicationSponza::terminate() {
...
void ApplicationSponza::on_key_pressed(const std::string& p_key) {
...
void ApplicationSponza::on_key_released(const std::string& p_key) {
    auto camera_dir = glm::normalize(glm::vec3(camera.get_direction().x, 0.0, camera.get_direction().z));
    if (p_key == "light_forward") {
        light_move_dir -= camera_dir;
    }
...
void ApplicationSponza::init_global_resources() {
...
void ApplicationSponza::init_resources() {
...
void ApplicationSponza::on_resize(unsigned int p_updated_x, unsigned int p_updated_y) {
